      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl items-center px-4 py-20 md:px-6">
        <div className="grid w-full items-center gap-14 lg:grid-cols-[1.15fr_.85fr]">
          <div className="animate-reveal">
            ...
            <p className="mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-muted-foreground">Computer Science student at UC Riverside building AI-powered developer tools, infrastructure, and full-stack systems.</p>
          ...
          <div className="relative mx-auto w-full max-w-md animate-reveal [animation-delay:150ms]">
            ...
            <div className="mt-4 grid grid-cols-3 gap-3 font-mono text-xs">
              {[['Focus','AI + Systems'],['Education','B.S.'],['School','UC Riverside']].map(([label,value]) => <div key={label} className="rounded-xl border border-border bg-card/60 p-3"><span className="block text-muted-foreground">{label}</span><span className="mt-1 block font-semibold text-primary">{value}</span></div>)}
            </div>
          </div>
          ...
          <div className="lg:col-span-2 glass-panel rounded-2xl p-6 md:p-8 animate-reveal [animation-delay:250ms]">
            ...
            <div className="grid gap-5 text-base leading-relaxed text-muted-foreground md:grid-cols-2">
              <p>I&apos;m currently pursuing a <strong className="text-foreground">B.S. in Computer Science</strong> at the University of California, Riverside.</p>
              <p>As an <strong className="text-foreground">ACM Project Lead</strong> and a <strong className="text-foreground">2nd-place UCRPC competitor</strong>, I enjoy taking ambiguous technical problems and turning them into working products.</p>
              <p>Across internships at <strong className="text-foreground">Panasonic Avionics</strong> and <strong className="text-foreground">SuperIntro</strong>, I&apos;ve worked on CI/CD automation, infrastructure tooling, APIs, and full-stack applications.</p>
              <p>Outside of software, you&apos;ll usually find me at the gym, playing soccer/pickleball, or practicing piano.</p>
            </div>
          </div>
        </div>
      </div>
