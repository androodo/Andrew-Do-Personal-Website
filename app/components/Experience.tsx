...
const experiences = [
  { title: "Software Engineer Intern", company: "Panasonic Avionics Corporation", logo: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-6ixDBsBMM3fz48ZmnAAkW0E5uhBglE.png", location: "Irvine, CA", period: "Jun. 2026 – Sep. 2026", achievements: ["Built a hybrid virtual/physical rack CI workflow for software deployment and configuration validation, automating PAC OS deployment and smoke/regression testing across AWS-backed virtual servers and physical test hardware, reducing repeated environment setup time by an estimated 60%.", "Engineered Python automation for nightly test reporting and failure triage, generating HTML reports and actionable Jira tickets from JUnit results, InfluxDB metrics, and test logs, reducing manual debugging effort by an estimated 70%.", "Built reusable AI developer tooling that encodes team-specific testing workflows for coding agents, then evaluated it through controlled baseline-vs-guided trials measuring code quality, convention adherence, duplicate-test detection, and reliability."] },
